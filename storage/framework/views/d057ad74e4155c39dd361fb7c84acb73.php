...
<body class="min-h-screen flex text-gray-800 select-none">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <!-- FORM PENCARIAN -->
        <div class="pb-3">
            <form class="d-flex" action="<?php echo e(url('dosen')); ?>" method="get">
        ...
        <!-- TOMBOL TAMBAH DATA -->
        <div class="pb-3">
            <a href='<?php echo e(url('dosen/create')); ?>' class="btn btn-primary">+ Tambah Data</a>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex gap-2">
                        <a href='<?php echo e(url('dosen/'.$item->nim. '/edit')); ?>' class="btn btn-warning btn-sm">Edit</a>
                        <form class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data ini?')"
                            action="<?php echo e(url('dosen'.$item->nim)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
