    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full md:w-1/2 flex flex-col justify-center items-center p-8">
            <div class="w-full max-w-sm">
                ...
                <form method="POST" action="<?php echo e(route('loginmahasiswa.submit')); ?>" 2>
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
                    ...
                    <a href="<?php echo e(route('siyuman')); ?>"
...
</html><?php /**PATH D:\MAHASISWA\nilai_mahasiswa\resources\views/auth/loginmahasiswa.blade.php ENDPATH**/ ?>